...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        //View 
        DB::unprepared('CREATE OR REPLACE VIEW view_daftar_absensi_guru AS SELECT dag.id_thnakademik,t.NIG,t.name,th.TahunAjaran,dag.absen,dag.izin,dag.sakit  FROM daftar_absensi_gurus dag INNER JOIN tahun_akademiks th ON th.id=dag.id_thnakademik INNER JOIN teachers t ON t.NIG=dag.id_guru');
