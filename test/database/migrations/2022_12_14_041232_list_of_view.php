...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE OR REPLACE VIEW data_rombel_thn AS SELECT r.id ,r.SMP ,k.nama_kelas, t.alias, t.NIG, th.TahunAjaran,jumlah_siswa(r.id) as jumlah  FROM rombels r INNER JOIN kelas k ON k.id=r.id_kelas LEFT JOIN teachers t ON t.NIG=r.id_wali INNER JOIN tahun_akademiks th ON th.id=r.id_thnakademik WHERE r.id_thnakademik=(SELECT th.id FROM tahun_akademiks th WHERE status ="Aktif" )');
