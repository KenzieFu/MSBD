...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared('CREATE OR REPLACE VIEW input_nilai_mapel AS SELECT ns.id_rsiswa,ns.id,ns.id_mapel,s.NIS,s.name as nama_siswa,rs.id_rombel, m.mapel, ns.nilai FROM nilai_siswas ns INNER JOIN rombel_siswas rs ON rs.id=ns.id_rsiswa INNER JOIN students s ON s.NIS=rs.id_siswa INNER JOIN mapels m ON m.id=ns.id_mapel');
